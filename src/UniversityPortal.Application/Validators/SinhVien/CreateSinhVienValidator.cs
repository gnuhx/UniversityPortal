// Validator tạo sinh viên — kiểm tra MSSV, tên đăng nhập và email
...
/// <summary>
/// Xác thực dữ liệu đầu vào khi tạo mới sinh viên.
/// </summary>
public class CreateSinhVienValidator : AbstractValidator<CreateSinhVienDto>
{
    public CreateSinhVienValidator()
    {
        ...
        RuleFor(x => x.Mssv)
            ...
            .MaximumLength(20).WithMessage("MSSV không quá 20 ký tự.");
    }
}
